...
is_deeply( $list->distributed_by_host,   { 'www.vg.no' => [ 'http://www.vg.no/index.html', 'http://www.vg.no/' ] } );
is_deeply( $list->distributed_by_domain, { 'vg.no'     => [ 'http://www.vg.no/index.html', 'http://www.vg.no/' ] } );
is_deeply( $list->distributed_by_tld,    { 'no'        => [ 'http://www.vg.no/index.html', 'http://www.vg.no/' ] } );
